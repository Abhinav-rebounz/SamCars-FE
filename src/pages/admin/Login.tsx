    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Sign in to access the dealer dashboard
        </p>
      </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              ...
              <div className="mt-3 text-center">
                ...
                <p className="text-sm text-gray-600">Email: <span className="font-mono">admin@saamcars.com</span></p>
                <p className="text-sm text-gray-600">Password: <span className="font-mono">password</span></p>
              </div>
            </div>
          </div>
        </div>
