        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-gray-600">Admin: <span className="font-mono">admin@saamcars.com</span> / <span className="font-mono">password</span></p>
            </div>
          </div>
        </div>
      </div>
